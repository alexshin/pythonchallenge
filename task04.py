source_string = """kAewtloYgcFQaJNhHVGxXDiQmzjfcpYbzxlWrVcqsmUbCunkfxZWDZjUZMiGqhRRiUvGmYmvnJIHEmbT
...
result = re.findall('[^A-Z][A-Z]{3}([a-z]{1})[A-Z]{3}[^A-Z]', source_string)
print(''.join(result))